---@type table
local Colour = {
    Background = { Dictionary = "commonmenu.ytd", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 112 },
    LeftArrow = { Dictionary = "commonmenu.ytd", Texture = "arrowleft", X = 7.5, Y = 15, Width = 30, Height = 30 },
    RightArrow = { Dictionary = "commonmenu.ytd", Texture = "arrowright", X = 393.5, Y = 15, Width = 30, Height = 30 },
